...
function preventLoad() {
  return (
    ...
    !window.confirm("You have unsaved changes by continuing you will lose those changes.")
  );
}

// Initialize the Drag and Drop area.
const { hide: hideDropTarget } = initializeDragAndDrop(load, onFail, preventLoad);
